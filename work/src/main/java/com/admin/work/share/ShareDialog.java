...
import com.admin.core.ui.view.CornerFrameLayout;
...
public class ShareDialog extends AlertDialog {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        layout.setViewOutline(StatusBarHeight.dip2px(20), ViewHelper.RADIUS_TOP);
        ...
        int margin = StatusBarHeight.dip2px(20);
    ...
    private class ShareAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
            ...
            AppCompatImageView imageView = holder.itemView.findViewById(R.id.share_icon);
